...
@Component({
  selector: 'app-sheduled-seminars',
  templateUrl: './sheduled-seminars.component.html',
  styleUrls: ['./sheduled-seminars.component.scss'],
})
export class SheduledSeminarsComponent implements AfterViewInit {
  loader = true;
  tableView = false;
